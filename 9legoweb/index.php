...
$ua_smartphone = "/(apple|android|iemobile|firefox|blackberry)/i";

/**
 * 不开启手机网
 *
if(!empty($_CFG['wap_config']) && ($ua == '' || preg_match($uachar, $ua)) && !strpos(strtolower($_SERVER['REQUEST_URI']),'wap') && !preg_match($ua_smartphone, $ua))
{
    $Loaction = 'mobile/';
