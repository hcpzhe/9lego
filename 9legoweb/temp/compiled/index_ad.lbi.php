...
<div class="container" id="idTransformView">
  ...
  <?php $_from = $this->_var['flash']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'flash');$this->_foreach['no'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['no']['total'] > 0):
    foreach ($_from AS $this->_var['flash']):
        $this->_foreach['no']['iteration']++;
?>
    <li><a href="<?php echo $this->_var['flash']['url']; ?>" target="_blank"><img src="<?php echo $this->_var['flash']['src']; ?>"/></li>
